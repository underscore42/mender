...
#list just one device
id=$1
RESPONSE=$(curl --insecure -X GET $MENDER_SERVER_URI/api/management/v2/devauth/devices/${id} -H 'Accept: application/json' -H "Authorization: Bearer $API_KEY")
